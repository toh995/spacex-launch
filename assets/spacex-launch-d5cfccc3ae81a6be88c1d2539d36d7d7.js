...
return Object.defineProperty(n,"__esModule",{value:!0}),n}catch(r){throw new Error('Could not read config from meta tag with name "'+e+'".')}})),runningTests||require("spacex-launch/app").default.create({name:"spacex-launch",version:"0.0.0+33a11e9c"})
